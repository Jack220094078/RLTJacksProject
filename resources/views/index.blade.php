            ...
            <div class="row">
                    ...
                    <div class="card shadow border-left-primary py-2">
                        <div class="card-body">
                            <div class="row g-0 align-items-center">
                                <div class="col me-2">
                                    <div class="text-uppercase text-primary fw-bold text-xs mb-1"><span>Module
                                            Content&nbsp;</span></div>
                    ...
                    <div class="card shadow border-left-success py-2">
                        <div class="card-body">
                            <div class="row g-0 align-items-center">
                                ...
                                <div class="col-auto"><i class="fas fa-percentage fa-2x text-gray-300"
                ...
                <div class="col-md-6 col-xl-3 mb-4">
                    <div class="card shadow border-left-info py-2">
                        <div class="card-body">
                            <div class="row g-0 align-items-center">
                                <div class="col me-2">
                                    <div class="text-uppercase text-info fw-bold text-xs mb-1"><span>Tasks To
                                            Do&nbsp;</span></div>
                                    <div class="row g-0 align-items-center">
                                        <div class="col-auto">
                                            <div class="text-dark fw-bold h5 mb-0 me-3"><span>50%</span></div>
                ...
                <div class="col-md-6 col-xl-3 mb-4">
                    <div class="card shadow border-left-warning py-2">
                        <div class="card-body">
                            <div class="row g-0 align-items-center">
                                <div class="col me-2">
                                    <div class="text-uppercase text-warning fw-bold text-xs mb-1"><span>2025 Academic
                                            year&nbsp;</span></div>
                ...
                <div class="col-lg-6 mb-4">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <h4 class="small fw-bold">Poll 1 Students who answered&nbsp;<span
                            ...
                            <h4 class="small fw-bold">Poll 2 Correct Answers Of Students&nbsp;<span
                            ...
                            <h4 class="small fw-bold">Poll 3 Answers for Correct and Incorrect&nbsp;<span
                            ...
                            <h4 class="small fw-bold">Poll 4 Correct Answers Of Students&nbsp;<span
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item">
                                <div class="row g-0 align-items-center">
                                    <div class="col me-2">
                                        <h6 class="mb-0"><strong>Lesson 2&nbsp;</strong></h6><span
                                            class="text-xs">12:00 AM</span>
                                    </div>
                                    <div class="col-auto">
                                        <div class="form-check"><input class="form-check-input" type="checkbox"
                                                id="formCheck-8"><label class="form-check-label"
                                                for="formCheck-8"></label></div>
                                    </div>
                                </div>
                            </li>
                            <li class="list-group-item">
                                <div class="row g-0 align-items-center">
                                    <div class="col me-2">
                                        <h6 class="mb-0"><strong>Lunch Time&nbsp;</strong></h6><span
                                            class="text-xs">12:30 AM</span>
                                    </div>
                                    <div class="col-auto">
                                        <div class="form-check"><input class="form-check-input" type="checkbox"
                                                id="formCheck-9"><label class="form-check-label"
                                                for="formCheck-9"></label></div>
                                    </div>
                                </div>
                            </li>
                            <li class="list-group-item">
                                <div class="row g-0 align-items-center">
                                    <div class="col me-2">
                                        <h6 class="mb-0"><strong>Lesson 3</strong></h6><span class="text-xs">13:30
                                            AM</span>
                                    </div>
                                    <div class="col-auto">
                                        <div class="form-check"><input class="form-check-input" type="checkbox"
                            ...
                            <li class="list-group-item">
                                <div class="row g-0 align-items-center">
                                    <div class="col me-2">
                                        <h6 class="mb-0"><strong>Lesson 4</strong></h6><span class="text-xs">14:30
                                            AM</span>
                                    </div>
                                    <div class="col-auto">
                                        <div class="form-check"><input class="form-check-input" type="checkbox"
            ...
            <div class="row">
                <div class="col-lg-6 mb-4">
                    ...
                    <div class="card shadow mb-3">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">Comments Pinned&nbsp;<svg
                        ...
                        <div class="card-body">
                            <form>
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3"><label class="form-label" for="username"><strong>Comment
                                                    1&nbsp;</strong></label><input class="form-control" type="text"
                                                id="username" placeholder="Comment 1 " name="username"></div>
                                    </div>
                                    <div class="col">
                                        <div class="mb-3"><label class="form-label" for="email"><strong>Comment
                                                    2&nbsp;</strong></label><input class="form-control" type="email"
                                                id="email" placeholder="Comment 2" name="email"></div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3"><label class="form-label"
                                                for="first_name"><strong>Comment 3&nbsp;</strong></label><input
                                                class="form-control" type="text" id="first_name"
                                                placeholder="Comment 3 " name="first_name"></div>
                                    </div>
                                    <div class="col">
                                        <div class="mb-3"><label class="form-label" for="last_name"><strong>Comment
                                                    4&nbsp;</strong></label><input class="form-control" type="text"
                                                id="last_name" placeholder="Comment 4 " name="last_name"></div>
                                    </div>
                                </div>
