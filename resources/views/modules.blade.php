    ...
    <div id="content">
        ...
        <div class="container-fluid">
                ...
                <div class="col-md-6 col-xl-3 mb-4">
                    <div class="card shadow border-left-info py-2">
                        <div class="card-body">
                            <div class="row g-0 align-items-center">
                                <div class="col me-2">
                                    <div class="text-uppercase text-info fw-bold text-xs mb-1"><span>Attendance</span>
                                    </div>
                                    <div class="row g-0 align-items-center">
                                        <div class="col-auto">
                ...
                <div class="col-md-6 col-xl-3 mb-4">
                    <div class="card shadow border-left-info py-2">
                        <div class="card-body">
                            <div class="row g-0 align-items-center">
                                <div class="col me-2">
                                    <div class="text-uppercase text-info fw-bold text-xs mb-1"><span>Tasks TO DO</span>
                                    </div>
                                    <div class="row g-0 align-items-center">
                                        <div class="col-auto">
                                            <div class="text-dark fw-bold h5 mb-0 me-3"><span>50%</span></div>
            ...
            <div class="row" style="padding-right: 0px;margin-right: -116px;">
                <div class="col-lg-7 col-xl-8 col-xxl-11"
                    style="padding: 24px;padding-left: 3px;padding-bottom: 40px;padding-top: 26px;margin-top: -4px;margin-bottom: -16px;padding-right: 11px;">
                    ...
                    <div class="card-group">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-text">Module 1 learning how to creating a new html file. Click below to
                                    find out more.</p><button class="btn btn-primary" type="button">Button</button>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Module 2&nbsp;</h4>
                                <p class="card-text">Module 2 Description</p><button class="btn btn-primary"
                        ...
                        <div class="card">
                            <div class="card-body" style="color: var(--bs-body-color);">
                                ...
                                <p class="card-text">Module 3 More lecture content here.&nbsp;</p><button
                                    class="btn btn-primary" type="button">Button</button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item">
                                <div class="row g-0 align-items-center">
                                    <div class="col me-2">
                                        <h6 class="mb-0"><strong>Lecture 2&nbsp;</strong></h6><span
                                            class="text-xs">11:30 AM</span>
                                    </div>
                                    <div class="col-auto">
                                        <div class="form-check"><input class="form-check-input" type="checkbox"
                                                id="formCheck-5"><label class="form-check-label"
                                                for="formCheck-5"></label></div>
                                    </div>
                                </div>
                            </li>
                            <li class="list-group-item">
