        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <div class="d-sm-flex justify-content-between align-items-center mb-4">
                    <h3 class="text-dark mb-0">Room 2 - Active</h3><a class="btn btn-primary" role="button"
                    ...
                    <div class="col-lg-6 mb-4"><video width="960" height="540" controls=""
                        ...
                        <div class="btn-toolbar" style="margin-right: -690px;">
                            <div class="btn-group" role="group"><button class="btn btn-primary" type="button"
                                    ...
                                    style="background: rgb(23,235,4);margin: 44px;"><input
                                        class="form-control-plaintext" type="text" value="B" readonly=""
                                        style="color: rgb(255,255,255);text-align: center;"></button><button
                                    class="btn btn-primary" type="button"
                                    style="background: rgb(41,8,245);margin: 44px;"><input
                                        class="form-control-plaintext" type="text" value="C" readonly=""
                                        style="color: rgb(255,255,255);text-align: center;"></button></div>
                            <div class="btn-group" role="group"></div>
                        </div><a class="btn btn-primary" role="button" href="Room2.html"
