                    ...
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-flex">
                                <div class="flex-grow-1 bg-login-image" style="background: url(&quot;assets/img/Aston%20University%20Coat%20of%20Arms%20CMYK%20(1).jpg&quot;) center / contain;width: 351px;"></div>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    @csrf
                                        ...
                                        <hr><a class="btn btn-primary d-block btn-google btn-user w-100 mb-2" role="button"href="{{route('register')}}"style="background: rgb(53,191,234);">Create Account</a>
                                        <hr>
                                    </form>
